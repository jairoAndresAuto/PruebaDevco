...
public class SeleccionarHotelPaquete implements Task {

    private String nombreHotel;
    private String numeroHabitacion;

    public SeleccionarHotelPaquete(String nombreHotel, String numeroHabitacion) {
    ...
    public static SeleccionarHotelPaquete con(String nombreHotel,String numeroHabitacion){
        return Tasks.instrumented(SeleccionarHotelPaquete.class,nombreHotel,numeroHabitacion);
    }
}
