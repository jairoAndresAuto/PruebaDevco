...
public class SeleccionarPaseos implements Task {

    private String nombreHotel;
    private String numeroHabitacion;

    public SeleccionarPaseos(String nombreHotel, String numeroHabitacion) {
    ...
    public static SeleccionarPaseos con(String nombreHotel,String numeroHabitacion){
        return Tasks.instrumented(SeleccionarPaseos.class,nombreHotel,numeroHabitacion);
    }
}
